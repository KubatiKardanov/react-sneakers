...
function Home( {sneakers, cartSneakers, searchValue, setSearchValue, onChangeSearchInput, onAddToFavorite, onAddToCart} ) {
    return (
        <div className="content p-40">
          ...
          <div className="searchBlock mb-40" >
            ...
            <div className="searchItem">
              ...
              {searchValue && <img onClick={() => setSearchValue('')} alt="clear" className="clearBtn" src="/img/deleteItem.svg" />}
